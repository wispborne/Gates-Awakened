...
class IntroIntelOld(target: SectorEntityToken) : BreadcrumbIntel(null, target) {
    ...
    override fun getTitle(): String = "Gate investigation" + if (isEnding) " - Completed" else String.empty
